...
export abstract class MainThreadLanguageFeaturesShape {
	...
	$registerCodeLensSupport(handle: number, selector: vscode.DocumentSelector, workspace?: IWorkspace): TPromise<any> { throw ni(); }
	 ...
	 */
	$notifyProvideReferencesProgress(handle: number, progressHandle: number, locations: modes.Location[], workspace?: IWorkspace): TPromise<any> { throw ni(); }
