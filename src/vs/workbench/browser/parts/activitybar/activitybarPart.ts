...
import { ToggleViewletPinnedAction, GlobalActivityActionItem, GlobalActivityAction, ViewletActivityAction, ToggleViewletAction, ActivityRunActionItem } from 'vs/workbench/browser/parts/activitybar/activitybarActions';
