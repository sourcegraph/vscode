...
import { WORKSPACE_FILTER_SAVE, WORKSPACE_FILTER_EXPORT, EXPORTED_WORKSPACE_EXTENSION, IWorkspacesService } from 'vs/platform/workspaces/common/workspaces';
...
export class NewEmptyWorkspaceAction extends Action {
