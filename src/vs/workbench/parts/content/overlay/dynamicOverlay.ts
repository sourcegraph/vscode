...
const keys: Key[] = [
	{
		id: 'explorer',
		arrow: '&larr;',
		label: localize('dynamicOverlay.explorer', "File explorer"),
		command: 'workbench.view.explorer'
	},
	{
		id: 'search',
		arrow: '&larr;',
		label: localize('dynamicOverlay.search', "Search across files"),
		command: 'workbench.view.search'
	},
	{
		id: 'git',
		arrow: '&larr;',
		label: localize('dynamicOverlay.git', "Source code management"),
		command: SCMPreview.enabled ? 'workbench.view.scm' : 'workbench.view.git'
	},
	{
		id: 'debug',
		arrow: '&larr;',
		label: localize('dynamicOverlay.debug', "Launch and debug"),
		command: 'workbench.view.debug'
	},
	{
		id: 'extensions',
		arrow: '&larr;',
		label: localize('dynamicOverlay.extensions', "Manage extensions"),
		command: 'workbench.view.extensions'
	},
	// {
	// 	id: 'watermark',
	// 	arrow: '&larrpl;',
	// 	label: localize('dynamicOverlay.watermark', "Command Hints"),
	// 	withEditor: false
	// },
	{
		id: 'problems',
		arrow: '&larrpl;',
		label: localize('dynamicOverlay.problems', "View errors and warnings"),
		command: 'workbench.actions.view.problems'
	},
	// {
	// 	id: 'openfile',
	// 	arrow: '&cudarrl;',
	// 	label: localize('dynamicOverlay.openfile', "File Properties"),
	// 	arrowLast: true,
	// 	withEditor: true
	// },
	{
		id: 'commandPalette',
		arrow: '&nwarr;',
		label: localize('dynamicOverlay.commandPalette', "Find and run all commands"),
