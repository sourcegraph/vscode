...
export class DynamicContentContentProvider implements ITextModelContentProvider, IWorkbenchContribution {
	...
	constructor(
		...
		this.textModelResolverService.registerTextModelContentProvider(Schemas.dynamicContent, this);
	}
...
export class DynamicContentSnippetContentProvider implements ITextModelContentProvider, IWorkbenchContribution {
	...
	constructor(
		...
		this.textModelResolverService.registerTextModelContentProvider(Schemas.dynamicContentSnippet, this);
	}
