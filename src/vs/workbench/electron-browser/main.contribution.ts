...
import { AddRootFolderAction, OpenWorkspaceAction, SaveWorkspaceAsAction, OpenWorkspaceConfigFileAction, ExportWorkspaceAction } from 'vs/workbench/browser/actions/workspaceActions';
