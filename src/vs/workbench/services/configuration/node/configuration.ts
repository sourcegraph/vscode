...
export class WorkspaceServiceImpl extends WorkspaceService {
	...
	protected triggerConfigurationChange(): void {
		this._onDidUpdateConfiguration.fire({ source: ConfigurationSource.Workspace, sourceConfig: this.workspace.folders[0] ? this._configuration.getFolderConfigurationModel(this.workspace.folders[0]).contents : void 0 });
	}
}
