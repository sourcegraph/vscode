...
export const SOURCEGRAPH_EVENT_MAP: { [eventName: string]: EventMapEntry } = {
	...
	// Keys
	'keyboardLayout': { eventCategory: EventCategory.Keys, eventAction: EventAction.Unknown },
	'updateKeybindings': { eventCategory: EventCategory.Keys, eventAction: EventAction.Unknown },
	'customKeybindingsChanged': { eventCategory: EventCategory.Keys, eventAction: EventAction.Unknown },
	'emacs.cursorDown': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
	'emacs.cursorUp': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
	'emacs.cursorRight': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
	'emacs.cursorLeft': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
	'emacs.cursorHome': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
	'emacs.cursorEnd': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
	'emacs.cursorWordRight': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
	'emacs.cursorWordLeft': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
	'emacs.cursorPageDown': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
	'emacs.cursorPageUp': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
	'emacs.cursorTop': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
	'emacs.cursorBottom': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
	'emacs.C-y': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
	'emacs.C-w': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
	'emacs.C-k': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
	'emacs.C-g': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
	'emacs.C-l': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
	'emacs.M-w': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
	'emacs.C-i': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
	'emacs.enterMarkMode': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
	'emacs.exitMarkMode': { eventCategory: EventCategory.Keys, eventAction: EventAction.Click, shouldLog: false },
