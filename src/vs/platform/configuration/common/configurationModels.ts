...
export class Configuration {
	...
	constructor(
		...
		private _organizationConfiguration: ConfigurationModel,
	...
	lookup<C>(key: string, overrides: IConfigurationOverrides, workspace: Workspace): {
		...
		return {
			...
			organization: getConfigurationValue<C>(overrides.overrideIdentifier ? this._organizationConfiguration.override(overrides.overrideIdentifier).contents : this._organizationConfiguration.contents, key),
	...
	keys(workspace: Workspace): {
		...
		return {
			...
			organization: this._organizationConfiguration.keys,
	...
	updateOrganizationConfiguration(organizationConfiguration: ConfigurationModel): void {
	...
	private getWorkspaceConsolidatedConfiguration(): ConfigurationModel {
		if (!this._workspaceConsolidatedConfiguration) {
			this._workspaceConsolidatedConfiguration = this._defaultConfiguration.merge(this._organizationConfiguration).merge(this._userConfiguration).merge(this._workspaceConfiguration).merge(this._memoryConfiguration).freeze();
		}
	...
	public static parse(data: IConfigurationData): Configuration {
		...
		return new Configuration(defaultConfiguration, organizationConfiguration, userConfiguration, workspaceConfiguration, folders);
	}
