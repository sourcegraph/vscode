...
export class Configuration {
	...
	inspect<C>(key: string, overrides: IConfigurationOverrides, workspace: Workspace): {
		...
		return {
			...
			organization: overrides.overrideIdentifier ? this._organizationConfiguration.freeze().override(overrides.overrideIdentifier).getValue(key) : this._organizationConfiguration.freeze().getValue(key),
