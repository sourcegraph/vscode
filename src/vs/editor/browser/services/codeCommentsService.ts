...
export interface IFileComments extends IEventDisposable {
	 ...
	 */
	readonly refreshingThreads: TPromise<void>;
	readonly onDidStartRefreshingThreads: Event<void>;
	 ...
	 */
	createDraftThread(editor: ICodeEditor, kind: DraftThreadKind): IDraftThreadComments;
