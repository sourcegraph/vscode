...
export interface ContextProvider {
	 ...
	 */
	resolveContext?(model: editorCommon.IReadOnlyModel, item: ContextItem, token: CancellationToken): ContextItem | Thenable<ContextItem>;
}
 ...
 * @internal
 */
export const ContextProviderRegistry = new LanguageFeatureRegistry<ContextProvider>();
