...
:: Integration Tests
.\scripts\code.bat %~dp0\..\extensions\remote --extensionDevelopmentPath=%~dp0\..\extensions\remote --extensionTestsPath=%~dp0\..\extensions\remote\out --disableExtensions --user-data-dir=%VSCODEUSERDATADIR%
