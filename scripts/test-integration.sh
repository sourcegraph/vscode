...
# Integration Tests
./scripts/code.sh $ROOT/extensions/remote --extensionDevelopmentPath=$ROOT/extensions/remote --extensionTestsPath=$ROOT/extensions/remote/out --disableExtensions --user-data-dir=$VSCODEUSERDATADIR
