...
# Integration Tests
./scripts/code.sh $ROOT/extensions/repo --extensionDevelopmentPath=$ROOT/extensions/repo --extensionTestsPath=$ROOT/extensions/repo/out --disableExtensions --user-data-dir=$VSCODEUSERDATADIR
...
# TODO(sqs): was failing tests 2017-08-10
